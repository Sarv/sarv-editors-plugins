...
It is called Chess in the interface and isn't installed by default in cloud, [self-hosted](https://github.com/Sarv/sarv-editors-plugins) and [desktop version](https://github.com/Sarv/sarv-editors-plugins) of Sarv Office editors. 

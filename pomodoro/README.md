# Pomodoro Timer Plugin for Sarv Office

This plugin adds a customizable Pomodoro Timer to Sarv Office, helping users improve productivity through structured focus and break intervals. With configurable focus/break times and optional white noise, this plugin offers a distraction-free environment for users working within Sarv Office.
...
2. Extract the files and upload them to your Sarv Office server’s plugin folder.
3. Enable the plugin in Sarv Office.

## Usage

1. Open Sarv Office and navigate to the plugins section.

...
It is called Thesaurus in the interface and is installed by default in cloud, [self-hosted](https://github.com/Sarv/sarv-editors-plugins) and [desktop version](https://github.com/Sarv/sarv-editors-plugins) of Sarv Office editors. 

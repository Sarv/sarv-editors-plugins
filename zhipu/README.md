...
1. Fill in the ZhiPu API Key in the plugin settings to enable API calls
    ...
    - In the Sarv Office editor, click on the plugin icon below, click on settings, and fill in your ZhiPu API Key to start using it.

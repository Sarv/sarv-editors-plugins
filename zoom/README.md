...
It is compatible with [self-hosted](https://github.com/Sarv/sarv-editors-plugins) version of Sarv Office editors. It can be added to Sarv Office instances manually.

# Sarv Office Zotero plugin

Zotero plugin allows users to create bibliographies in Sarv Office editors using Zotero service.

The plugin is pre-installed in Sarv Office Workspace (both Enterprise and Community Edition), Sarv Office cloud service, and Sarv Office Personal. It can also be installed to Document Server and desktop editors manually.
...
1.  Put the folder with the plugin code to Sarv Office Document Server folder depending on the operating system:
    ...
    The plugins will be available to all the users of Sarv Office Document Server.
...
1. Find Zotero plugin in `Plugins` tab of the Sarv Office Document Editor and click it.
